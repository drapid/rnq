    ...
    object O: TPageControl
      ...
      object TS1: TTabSheet
        ...
        object bdayBox: TDateTimePicker
          ...
          Date = 37466.562277013900000000
          Time = 37466.562277013900000000
          TabOrder = 9
        end
        ...
        object dcGrp: TRadioGroup
          Left = 6
          Top = 98
          Width = 161
          Height = 68
          Caption = 'IP address visible for'
          Items.Strings = (
            'Noone'
            'My contacts'
            'Anyone')
      ...
      object SecTS: TTabSheet
        ...
        object SaveMD5chk: TCheckBox
          Left = 6
          Top = 44
          Width = 360
          Height = 17
          Caption = 'Save MD5 hash instead password'
          TabOrder = 1
          OnClick = UpdVis
        end
      ...
      object AddTrafTB: TTabSheet
        ...
        object SendUTF8Chk: TCheckBox
          Left = 6
          Top = 6
          Width = 321
          Height = 17
          Caption = 'Send UTF-8 support'
          TabOrder = 1
        end
        object UTF8MsgsChk: TCheckBox
          Left = 199
          Top = 6
          Width = 321
          Height = 17
          Caption = 'Send UTF-8 messages'
          TabOrder = 0
        end
        ...
        object AdvMsgChk: TCheckBox
          Left = 6
          Top = 23
          Width = 381
          Height = 17
          Hint = 'Send messages with advanced method'
          Caption = 'Send messages with advanced method'
          TabOrder = 11
        end
