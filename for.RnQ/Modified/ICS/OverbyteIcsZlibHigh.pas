...
const
   MAX_WBITS     = 15; { 32K LZ77 window } // Added by Rapid D
   MAX_MEM_LEVEL = 9;
...
function DMAOfStream(AStream: TStream; out Available: Cardinal): Pointer;
...
begin
  ...
  try
    ...
    strm.next_out := nil;
    strm.avail_out := 0;
    ZlibDCheck(inflateBackInit(strm, MAX_WBITS, @BackObj.Window[0]));
    try
