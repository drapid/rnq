...
// *********************************************************************//
  ICanHandleException = interface(IUnknown)
    ...
    function CanHandleException(var pExcepInfo: EXCEPINFO; const pvar: OleVariant): HResult; stdcall;
  end;
...
begin
  ...
  TControlData2(CControlData).FirstEventOfs := UIntPtr(@@FOnReadyStateChange) - UIntPtr(Self);
end;
...
begin
  DefaultInterface.InlineData := ppIUnknown;
end;
