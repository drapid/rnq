...
function SQLite3_Open16(dbname: PWideChar; var db: TSqliteDB): integer; cdecl; external SQLiteDLL name 'sqlite3_open16';
...
function Sqlite3_columnText16(hstatement: TSqliteStmt; ColNum: integer): PWideChar; cdecl; external SQLiteDLL name 'sqlite3_column_text16';
...
function SQLite3_Bind_text16(hStmt: TSqliteStmt; ParamNum: integer;
  Data: PWideChar; numBytes: integer; ptrDestructor: pointer): integer;
