...
//  SQLite3_Open16: function(dbname: PChar; var db: TSQLite3DbHandle): integer; cdecl;
  SQLite3_Open: function(dbname: PUtf8Char; var db: TSQLite3DbHandle): integer; cdecl;
  ...
  sqlite3_prepare_v2: function(DB: TSQLite3DbHandle; SQL: PUTF8Char; SQL_bytes: integer;
                        var S: TSQLite3StmtHandle; var SQLtail: PUTF8Char): integer; cdecl;
  sqlite3_key : function(DB: TSQLite3DbHandle; const PKey: PAnsiChar; nKey: Integer): Integer;

  sqlite3_rekey : function(DB: TSQLite3DbHandle; const PKey: PAnsiChar; nKey: Integer): Integer;
...
uses
  StrUtils,
  Windows
{$IFDEF ASGSQLite_debug}
  ,ASGSQLite3Dbg
{$ENDIF ASGSQLite_debug}
  ;
...
//      if not Assigned(@SQLite3_Open16) then raise AsgError.Create('DLL::SQlite3Open16 not found')
      ...
      else if not Assigned(@SQLite3_Free) then AsgError.Create('DLL::SQlite3Free not found')
