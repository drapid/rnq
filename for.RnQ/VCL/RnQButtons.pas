...
uses Windows, Messages, Forms, Classes, Controls, Graphics, StdCtrls, Themes,
  RnQGraphics32,
  ExtCtrls, CommCtrl, Menus, UITypes,
 {$IFDEF RNQ}
  RQThemes,
 {$ENDIF RNQ}
  RDGlobal;
...
//        Options.crText := ColorToRGB(Canvas.Font.Color);
        Options.crText := clr;
  //      with StyleServices.GetElementDetails(tbPushButtonNormal) do
  //        DrawThemeTextEx(StyleServices.Theme[teButton], DC, Part, State,
  //          PWideChar(WideString(Text)), Length(Text), TextFlags, @TextRect, Options);
          with StyleServices.GetElementDetails(thmBtn) do
            DrawThemeTextEx(StyleServices.Theme[teButton], DC, Part, State,
  //          with StyleServices.GetElementDetails(twCaptionActive) do
  //            DrawThemeTextEx(StyleServices.Theme[teWindow], MemDC, Part, State,
...
//    PaintRect := ClientRect;
    ...
    begin
      ...
      ExtraRect := StyleServices.ContentRect(Canvas.Handle, Details, ExtraRect);
    end
    else
    begin
      Details := StyleServices.GetElementDetails(ToolButton);
...
//        PaintBuffer := 0;
    ...
    R := StyleServices.ContentRect(MemDC, Details, DrawItemStruct.rcItem);
